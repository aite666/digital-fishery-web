    ...
    <el-form :model="inspectionDetail" :rules="rules" ref="inspectionForm" label-width="120px">
      ...
      <el-form-item label="品种繁育指标数据：" prop="productData">
        <el-input
          ...
          type="textarea"
          placeholder="请输入品种繁育指标数据"></el-input>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" @click="onSubmit('inspectionForm')">提交</el-button>
        <el-button v-if="!isEdit" @click="resetForm('inspectionForm')">重置</el-button>
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$confirm('是否提交数据', '提示', {
              ...
              if (this.isEdit) {
                updateInspection(this.$route.query.id, this.inspectionDetail).then(response => {
                  this.$message({
                    message: '修改成功',
                    type: 'success',
                    duration: 1000
