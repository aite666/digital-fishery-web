<template>
  <el-card class="form-container" shadow="never">
    <el-form
      :model="storageRecordDetail"
      :rules="rules"
      ref="storageRecordForm"
      label-width="120px"
    >
      ...
      <el-form-item label="农资名称：" prop="name">
        <el-select
          v-model="storageRecordDetail.storageId"
      ...
      <el-form-item label="数量：" prop="quantity">
        <el-input-number
          v-model="storageRecordDetail.quantity"
          :min="0"
      ...
      <el-form-item label="价格：" prop="price">
        <el-input-number
          v-model="storageRecordDetail.price"
          :min="0"
          :max="100000000000000000"
        ></el-input-number>
      ...
      <el-form-item>
        <el-button type="primary" @click="onSubmit('storageRecordForm')"
          >提交</el-button
        >
        <el-button v-if="!isEdit" @click="resetForm('storageRecordForm')"
          >重置</el-button
        >
  ...
  methods: {
    ...
    getStorageDetail() {
      if (this.storageRecordDetail.storageId) {
        getStorageDetail(this.storageRecordDetail.storageId).then(
          (response) => {
