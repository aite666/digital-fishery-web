        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">待处理告警</span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">已处理告警</span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="un-handle-item">
              ...
              <span style="float: right" class="color-danger">(100)</span>
            </div>
          </el-col>
        </el-row>
        <el-row :gutter="20">
      ...
      <el-row>
        <el-col :span="4">
          <div style="padding: 20px">
            <div>
              <div style="color: #909399;font-size: 14px">本月养殖总数</div>
            ...
            <div style="margin-top: 20px;">
              <div style="color: #909399;font-size: 14px">本月农资总额</div>
