<template>
  <el-card class="form-container" shadow="never">
    <el-form :model="enterpriseDetail" :rules="rules" ref="enterpriseForm" label-width="120px">
      ...
      <el-form-item>
        ...
        <el-button v-if="!isEdit" @click="resetForm('enterpriseForm')">重置</el-button>
...
<script>
  import {fetchList,createEnterprise,updateEnterprise,deleteEnterprise,getEnterpriseDetail} from '@/api/enterprise'
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$confirm('是否提交数据', '提示', {
              ...
              if (this.isEdit) {
                updateEnterprise(this.$route.query.id, this.enterpriseDetail).then(response => {
                  this.$message({
                    message: '修改成功',
                    type: 'success',
                    duration: 1000
